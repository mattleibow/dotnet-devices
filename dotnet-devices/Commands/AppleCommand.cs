...
namespace DotNetDevices.Commands
{
    public class AppleCommand
    {
        ...
        {
            return new Command("apple", "Work with Apple (iOS, watchOS and tvOS) simulators.")
            {
                new Command("list", "List the simulators.")
                {
                ...
                }.WithHandler(CommandHandler.Create(typeof(AppleCommand).GetMethod(nameof(HandleListAsync))!)),
                ...
                }.WithHandler(CommandHandler.Create(typeof(AppleCommand).GetMethod(nameof(HandleBootAsync))!)),
            };
